@extends('layouts.app')
@section('title', __('error.500.title') . ' – WS4U')
@section('content')
<div class="gradient-ws4u min-h-screen flex items-center justify-center px-4">
    <div class="text-center">
        ...
        <h1 class="text-4xl font-bold text-white mt-4 mb-4">{{ __('error.500.title') }}</h1>
        <p class="text-slate-300 mb-8">{{ __('error.500.text') }}</p>
