...
<div class="bg-[#0f172a] text-white py-20 px-4 text-center">
    <div class="max-w-4xl mx-auto">
        ...
        <p class="text-xl text-slate-400">{{ app()->getLocale() == 'cs' ? 'Hotová SaaS řešení pro specifická odvětví, nebo vývoj přesně podle vašich požadavků.' : 'Ready-made SaaS solutions for specific industries, or development exactly according to your requirements.' }}</p>
    </div>
</div>
<section class="py-20 bg-[#111827]">
    <div class="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-10">
        <!-- Fotacek -->
        <a href="{{ route('products.fotacek') }}" class="group bg-[#1e293b]/50 rounded-3xl p-10 border border-slate-800 shadow-sm card-hover relative overflow-hidden">
            <div class="absolute top-6 right-6 badge-pill border-sky-500/30 text-sky-400 bg-sky-500/5">
            ...
            <h2 class="text-3xl font-bold text-white mb-4 group-hover:text-sky-400 transition-colors">Fotáček.cz</h2>
        ...
        <!-- GastroTech -->
        <a href="{{ route('products.gastrotech') }}" class="group bg-[#1e293b]/50 rounded-3xl p-10 border border-slate-800 shadow-sm card-hover relative overflow-hidden">
            <div class="absolute top-6 right-6 badge-pill border-sky-500/30 text-sky-400 bg-sky-500/5">
                {{ __('home.products.badge') }}
            </div>
            ...
            <h2 class="text-3xl font-bold text-white mb-4 group-hover:text-sky-400 transition-colors">GastroTech</h2>
            <p class="text-slate-400 leading-relaxed mb-6">
        ...
        <!-- MaponCulture -->
        <a href="{{ route('products.maponculture') }}" class="group bg-[#1e293b]/50 rounded-3xl p-10 border border-slate-800 shadow-sm card-hover relative overflow-hidden">
            <div class="absolute top-6 right-6 badge-pill border-sky-500/30 text-sky-400 bg-sky-500/5">
                {{ __('home.products.badge') }}
            </div>
            ...
            <h2 class="text-3xl font-bold text-white mb-4 group-hover:text-sky-400 transition-colors">MaponCulture</h2>
            <p class="text-slate-400 leading-relaxed mb-6">
        ...
        <!-- Custom -->
        <a href="{{ route('products.custom') }}" class="group bg-[#1e293b]/50 rounded-3xl p-10 border border-slate-800 shadow-sm card-hover relative overflow-hidden">
            <div class="absolute top-6 right-6 badge-pill border-sky-500/30 text-sky-400 bg-sky-500/5">
                {{ __('home.products.badge') }}
            </div>
            ...
            <h2 class="text-3xl font-bold text-white mb-4 group-hover:text-sky-400 transition-colors">{{ app()->getLocale() == 'cs' ? 'Vývoj na míru' : 'Custom Development' }}</h2>
            <p class="text-slate-400 leading-relaxed mb-6">
